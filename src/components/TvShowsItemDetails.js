...
export default function TvShowsItemDetails(props) {
        ...
        <div className="container p-0">
            <div className="row w-100 moviedetailpage">
                ...
                >
                    ...
                    <div className="date"><h4>First Air Date : {results.first_air_date}</h4></div>
                    {/* <div className="date"><h4>Episode No. : {results.last_episode_to_air.episode_number}</h4></div> */}
